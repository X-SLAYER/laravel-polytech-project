        ...
        <div class="row">
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ url('/contact/create') }}" class="btn btn-primary d-none d-sm-inline-block" title="Add New Contact">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                @foreach($contacts as $item)
                                    <tr>
                                        <td><span class="avatar avatar-sm" style="background-image: url(https://api.multiavatar.com/{{str_replace(" ","", $item->name) }}.png)"></span></td>
                                        <td>{{ $item->name }}</td>
                                        <td>{{ $item->address }}</td>
                                        <td>{{ $item->mobile }}</td>
                                        <td>
